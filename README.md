...
- <b>'kill'</b> : 본 프로그램을 통해 생성된 모든 process를 kill합니다. * 단순 종료시에도 같은 로직 실행함. <br>=> 2.0.0 업데이트 삭제
...
### GUI v2.0.0
![image](https://user-images.githubusercontent.com/55127127/113537417-a7e0ba80-9613-11eb-8924-eb3ffb9b8efd.png)
